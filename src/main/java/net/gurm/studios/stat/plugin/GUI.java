...
public class GUI {
    ...
    public void SGUI(Player p,Player sp) {
        long[] i;
        ...
        Stack(ChatColor.BOLD + ""+ChatColor.DARK_PURPLE + p.getPlayerListName(), 384, 0, 1,
    ...
    public void SGUI_click(InventoryClickEvent e)
    {
        ...
        if(ChatColor.stripColor(e.getInventory().getTitle()).equalsIgnoreCase("스테이터스"))
        {
